...
public class BlueSourceSideTwoNote extends SequentialCommandGroup {
  /** Two Note Blue Source */
  public BlueSourceSideTwoNote(Drivetrain drivetrain, Intake intake, Shooter shooter, ShooterPivot shooterpivot, LimelightShooter ls, LimelightIntake li) {
