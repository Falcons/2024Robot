...
public class RedSourceSideTwoNote extends SequentialCommandGroup {
  /** Creates a new SideTaxi. */
  public RedSourceSideTwoNote(Drivetrain drivetrain, Intake intake, Shooter shooter, ShooterPivot shooterpivot, LimelightShooter ls, LimelightIntake li) {
