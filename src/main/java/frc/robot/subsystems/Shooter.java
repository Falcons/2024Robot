...
public class Shooter extends SubsystemBase {
  ...
  // private final TalonFXConfiguration leftFlywheelConfig = new TalonFXConfiguration();
  private final TalonFXConfiguration rightFlywheelConfig = new TalonFXConfiguration();
  ...
  public Shooter() {
    ...
    rightFlywheelConfig.MotorOutput.Inverted = InvertedValue.CounterClockwise_Positive;
